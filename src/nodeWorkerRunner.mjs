  ...
  try {
    ...
    const context = {
      ...
      getRemainingTimeInMillis: () => 2147483647, // Max 32-bit signed integer
        ...
        throw new Error(
          '`done` function on lambda Context is not implemented in CDK Booster.',
        );
      },
      fail() {
        throw new Error(
          '`fail` function on lambda Context is not implemented in CDK Booster.',
        );
      },
      succeed() {
        throw new Error(
          '`succeed` function on lambda Context is not implemented in CDK Booster.',
        );
      },
    };
