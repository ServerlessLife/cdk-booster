...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'msapplication-TileColor', content: '#57ABFB' }],
    ...
    ['meta', { property: 'og:image', content: 'https://cdkbooster.com/cdk_booster.png' }],
    ...
    [
      'script',
      { async: '', src: 'https://www.googletagmanager.com/gtag/js?id=G-J8STRKN01N' }
    ],
    [
      'script',
      {},
